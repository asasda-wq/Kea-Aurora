...
import Classify.UIED.UIED_detect_compo.lib_ip.ip_draw as draw
import Classify.UIED.UIED_detect_compo.lib_ip.ip_preprocessing as pre
from Classify.UIED.UIED_detect_compo.lib_ip.Component import Component
import Classify.UIED.UIED_detect_compo.lib_ip.Component as Compo
from Classify.UIED.UIED_config.CONFIG_UIED import Config
C = Config()
