...
def load_ymal_args(opts):
    ...
    for key, value in config_dict.items():
        ...
        elif key.lower() == "number_of_events_that_restart_app" and value:
            opts.number_of_events_that_restart_app = value
        elif key.lower()=="utg" and value:
            opts.generate_utg=value
    return opts
